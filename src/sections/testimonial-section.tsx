...
export default function TestimonialSection() {
    const cardsData: CardProps[] = [
        {
            ...
            name: 'Emma Thompson',
            handle: 'Homeowner, London',
        },
        {
            image: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200',
            name: 'Liam Roberts',
            handle: 'Office Manager, Manchester',
        },
        {
            image: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&auto=format&fit=crop&q=60',
            name: 'Sophia Clarke',
            handle: 'Business Owner, Birmingham',
        },
        {
            image: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&auto=format&fit=crop&q=60',
            name: 'Oliver Green',
            handle: 'Property Manager, Leeds',
        },
    ];
    ...
    const CreateCard = ({ card }: { card: CardProps }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 bg-white">
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p className="font-semibold text-slate-700">{card.name}</p>
            ...
            <p className="text-sm py-4 text-gray-800">
                "Pure Clean Solutions transformed our office! Spotless, fast, and eco-friendly. Highly recommend their team."
            </p>
        </div>
    );
    ...
    return (
        <>
            <SectionTitle
                badge="Testimonials"
                icon={<MessageCircleCodeIcon className="size-4 stroke-green-600" />}
                title="Loved by homes & businesses"
                description="See what our clients say about our professional cleaning services."
            />
